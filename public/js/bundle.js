...
var bookButton = document.getElementById('book-tour'); //VALUES
//DELEGATION
...
if (bookButton) {
  bookButton.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // У нас в шаблоне tour-id, но джаваскрипт преобразует автоматом это в tourId
